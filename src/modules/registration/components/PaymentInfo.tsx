...
export default function PaymentInfo({
  ...
  return (
    <section className="py-16 md:py-20 lg:py-24 px-4 md:px-6 lg:px-8 bg-gradient-to-br from-background to-muted/40">
      <div className="container mx-auto max-w-5xl">
        <div className="bg-card rounded-2xl shadow-xl overflow-hidden">
          <div className="bg-gradient-to-r from-primary to-primary-foreground px-6 md:px-8 py-6">
            ...
            {showBankSection && (
              <div>
                <h3 className="text-xl font-bold text-foreground flex items-center gap-3 mb-6">
                  <FaUniversity className="w-6 h-6 text-primary" />
                  Bank Transfer
                </h3>
                <div className="flex flex-col lg:flex-row items-center gap-8">
                  <div className="bg-accent/20 p-6 rounded-xl border-2 border-accent w-full lg:w-auto">
