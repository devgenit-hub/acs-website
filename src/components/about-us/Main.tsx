...
export default function Main() {
  return (
    <section className="py-16 md:pt-24 px-4 md:px-8 lg:px-16 container mx-auto mb-24">
      {/* Heading */}
      ...
      {/* Paragraph */}
      <p className="leading-relaxed md:leading-loose text-justify max-w-4xl mx-auto mb-10">
